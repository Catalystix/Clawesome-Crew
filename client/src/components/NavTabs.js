      ...
      <Menu pointing secondary  size="large">
        <Menu.Item
          ...
          style={{
            ...
            borderBottom: currentPage === 'APODsection' ? '2px solid #d1d7e0' : '',
          }}
        />
        <Menu.Item
          name='Mars Photos'
          ...
          style={{
            ...
            borderBottom: currentPage === 'MarsDisplay' ? '2px solid #d1d7e0' : '',
          }}
        />
        <Menu.Item
          name='Space Articles'
          ...
          style={{
            ...
            borderBottom: currentPage === 'TechArticle' ? '2px solid #d1d7e0' : '',
          }}
        />
        <Menu.Item
          name='Resume'
